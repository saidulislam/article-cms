...
def login():
    app.logger.warning('**** SILOG: login() method called.')
    if current_user.is_authenticated:
        app.logger.warning('**** SILOG: Authenticated! Valid username and password entered.')
        return redirect(url_for('home'))
    form = LoginForm()
    if form.validate_on_submit():
        ...
        if user is None or not user.check_password(form.password.data):
            ...
            app.logger.warning('**** SILOG: Invalid username or password')
